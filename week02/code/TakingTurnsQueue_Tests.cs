...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The queue did not maintain FIFO order; Sue was returned before Bob. This was due to the queue implementation using Insert(0, ...) instead of Add(...), causing LIFO behavior.
    ...
    // Defect(s) Found: The queue did not maintain FIFO order; Sue was returned before Tim. This was due to the queue implementation using Insert(0, ...) instead of Add(...), causing LIFO behavior.
